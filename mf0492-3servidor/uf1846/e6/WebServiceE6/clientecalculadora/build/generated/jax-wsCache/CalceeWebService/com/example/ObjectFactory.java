...
public class ObjectFactory {
    ...
    private final static QName _Division_QNAME = new QName("http://example.com/", "Division");
    private final static QName _DivisionResponse_QNAME = new QName("http://example.com/", "DivisionResponse");
    private final static QName _Multiplication_QNAME = new QName("http://example.com/", "Multiplication");
    private final static QName _MultiplicationResponse_QNAME = new QName("http://example.com/", "MultiplicationResponse");
    private final static QName _Subtraction_QNAME = new QName("http://example.com/", "Subtraction");
    private final static QName _SubtractionResponse_QNAME = new QName("http://example.com/", "SubtractionResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example.com/", name = "Division")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example.com/", name = "DivisionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example.com/", name = "Multiplication")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example.com/", name = "MultiplicationResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example.com/", name = "Subtraction")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example.com/", name = "SubtractionResponse")
